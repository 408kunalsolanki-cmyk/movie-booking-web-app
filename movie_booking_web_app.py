...
Original file is located at
    https://colab.research.google.com/drive/1OtltVLalIEDkz6IiCE1k7iy_vMuHq4KF
"""
...
if step == 5:
    ...
    <div class="ticket-card">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;text-align:left;margin:1rem 0">
        ...
        <div><div style="color:#6b6b6a;font-size:0.75rem;text-transform:uppercase">Screen</div><div style="color:#f0f0ff;font-size:0.88rem;font-weight:500">{st.session_state.selected_screen}</div></div>
        <div><div style="color:#6b6b6a;font-size:0.75rem;text-transform:uppercase">Date</div><div style="color:#f0f0ff;font-size:0.88rem;font-weight:500">{st.session_state.selected_date}</div></div>
        <div><div style="color:#6b6b6a;font-size:0.75rem;text-transform:uppercase">Showtime</div><div style="color:#f0f0ff;font-size:0.88rem;font-weight:500">{st.session_state.selected_showtime}</div></div>
        <div><div style="color:#6b6b6a;font-size:0.75rem;text-transform:uppercase">Seats</div><div style="color:#e63946;font-size:0.88rem;font-weight:600">{', '.join(selected)}</div></div>
        <div><div style="color:#6b6b6a;font-size:0.75rem;text-transform:uppercase">Total Paid</div><div style="color:#f4a261;font-size:0.88rem;font-weight:600">₹{total:.0f}</div></div>
      </div>
      <hr class="ticket-divider">
      <div style="color:#6b6b6a;font-size:0.78rem">Booked for &nbsp;<strong style="color:#f0f0ff">{st.session_state.booking_name}</strong></div>
      <div style="color:#6b6b6a;font-size:0.78rem;margin-top:2px">{st.session_state.booking_email} &nbsp;|&nbsp; {st.session_state.booking_phone}</div>
